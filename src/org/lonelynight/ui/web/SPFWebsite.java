...
public class SPFWebsite extends org.spf.mobi.ui.SPFActivity implements org.spf.utils.Constants {
    ...
    protected void onCreate(android.os.Bundle a)
    {
        ...
        SPFWebsite.MyWebViewClient a20 = new SPFWebsite.MyWebViewClient();
    ...
    protected android.app.Dialog onCreateDialog(int i)
    {
        ...
        else
        {
            ...
            a1.setOnCancelListener((android.content.DialogInterface.OnCancelListener)new DialogInterface.OnCancelListener() {
                
                public void onCancel(DialogInterface a)
                {
                    SPFWebsite.this.finish();
                }
            });
    ...
    class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView a, SslErrorHandler a0, SslError a1)
        {
            a0.proceed();
        }
    }
