...
public class SPFAppeal implements Parcelable {
    final private static Parcelable.Creator<SPFAppeal> CREATOR;
    ...
    static
    {
        ...
        CREATOR = new Parcelable.Creator<SPFAppeal>() {

    		
        	@Override
    		public SPFAppeal createFromParcel(Parcel a)
    		{
        		return new SPFAppeal(a);
    		}
        	
        	@Override
    		public SPFAppeal[] newArray(int i)
    		{
        		return new org.spf.data.SPFAppeal[i];
    		}
	};
    }
    ...
    public static Parcelable.Creator<SPFAppeal> getCreator()
    {
        return CREATOR;
    }
